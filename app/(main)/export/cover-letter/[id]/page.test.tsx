 ...
 *
 * 이력서 상세와 같은 결함이 이 파일에도 복제돼 있었다. App Router 는 id 만 바뀌면 같은
...
/**
 * FRT-191 — 저장에 **성공**해도 남던 복원 배너. 이력서 상세와 같은 결함이 여기에도 복제돼
 ...
 * 이력서가 같은 자리에서 같은 이유로 표식을 미리 소비한다 — 자소서에만 그 처리가 빠져 있었다.
 */
describe("FRT-107 — 복원은 새 편집이 아니다", () => {
  ...
  // 이력서가 같은 이유로 표식을 소진한다 — 두 기능이 갈리면 나란히 못 놓는다.
