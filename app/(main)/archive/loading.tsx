export default function ArchiveLoading() {
  return (
    <>
      {/* Desktop skeleton (md+) */}
      <div className="hidden md:flex h-[calc(100dvh-var(--gnb-h))] overflow-hidden animate-pulse">
      ...
      {/* Mobile skeleton (<md) */}
      <div className="md:hidden h-[calc(100dvh-var(--gnb-h))] overflow-hidden animate-pulse bg-surface-secondary">
