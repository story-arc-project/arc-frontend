...
- [ ] 처리방침 고지: 위탁·국외이전(Google/PostHog/Vercel/Sentry)·자동분석(AI) — 정책/법무
      *(Sentry 는 FRT-183/192/201 로 수집을 중단했으나 기수집 녹화본이 남아 있다.
      보관도 처리이므로 sentry.io 파기를 확인하기 전까지는 고지 대상으로 유지한다.)*
